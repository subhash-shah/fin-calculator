...
export const bucketCalculator: Calculator = {
  ...
  fields: [
    { key: 'capital', label: 'Investment capital', default: 30000000, min: 0, max: 1000000000, step: 100000, required: true },
    {
      key: 'portion',
      ...
      step: 1,
      required: true,
      hint: (v) => `Bucket 2 (reserve) gets ${100 - (v.portion ?? 50)}%`,
    },
    { key: 'return1', label: 'Bucket 1 return % / year', default: 6, min: 0, max: 50, step: 0.5, required: false },
    { key: 'return2', label: 'Bucket 2 return % / year', default: 12, min: 0, max: 50, step: 0.5, required: false },
    ...
    { key: 'years', label: 'Years', default: 30, min: 1, max: 60, step: 1, required: true },
  ],
